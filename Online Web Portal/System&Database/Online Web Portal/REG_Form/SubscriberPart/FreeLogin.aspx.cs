...
public partial class FreeLogin : System.Web.UI.Page
{
    ...
    protected void btnFreeLogin_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        SqlCommand cmd = new SqlCommand("select * from tb_Register WHERE Username='" + txtUsername.Text + "' and Password='" + txtPassword.Text + "' and Subscription= 'Free'", con);
        cmd.ExecuteNonQuery();
